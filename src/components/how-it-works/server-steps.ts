...
export const SERVER_PROVIDERS: ServerProvider[] = [
  {
    ...
    steps: [
      {
        title: "Servidor já configurado!",
        subtitle: "Nenhuma ação necessária — seu servidor já está ativo",
        explanation: [
          "O CapiTrack já usa Edge Functions como backend. Seu servidor de rastreamento **já está funcionando automaticamente** — você não precisa colocar essa URL em lugar nenhum manualmente.",
          "**O que já está pronto:**",
          "- ✅ Servidor ativo e recebendo eventos",
          "- ✅ Deploy automático a cada atualização",
          "- ✅ Escalável globalmente",
          "- ✅ SDK do seu site já envia para este endpoint",
          "**Onde essa URL é usada?**",
          "- O SDK (script instalado no seu site) já aponta automaticamente para este endpoint",
          "- Você NÃO precisa copiar ou colar essa URL em nenhum lugar",
          "- Ela é apenas para referência/debug caso precise testar manualmente:",
        ],
        copySnippet: "https://xpgsipmyrwyjerjvbhmb.supabase.co/functions/v1/track",
        tip: "Apenas clique em 'Concluir' e prossiga para configurar a plataforma (Facebook ou Google). O servidor já está pronto!",
        referenceLinks: [
          { label: "Documentação Edge Functions", url: "https://supabase.com/docs/guides/functions" },
        ],
