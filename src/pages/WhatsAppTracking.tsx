  ...
  return (
    <div className="space-y-6 animate-fade-in">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        <MetricCard title="Cliques" value={stats.total.toLocaleString()} icon={<MessageCircle />} />
        <MetricCard title="Conversões" value={stats.converted.toLocaleString()} icon={<CheckCircle2 />} />
        <MetricCard title="Taxa" value={`${stats.rate.toFixed(1)}%`} icon={<Clock />} />
        <MetricCard
